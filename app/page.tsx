                  ...
                  <div className="border-b pb-7 mb-7">
                    <div className="flex">
                      ...
                      <div className="ml-10 w-5/6">
                        ...
                        <div className="mt-5">
                          <p className="text-lg font-light">
                            The call ahead seating feature offered by open table
                            worked well. Food is good but not great, best part
                            of the evening was Laura, a very upbeat and friendly
                            server who was genuinely caring and helpful to all
                            of us.
                          </p>
                        </div>
                      </div>
