          ...
          <div className="py-3 px-36 mt-10 flex flex-wrap">
            ...
            <div className="w-64 h-72 m-3 rounded overflow-hidden border cursor-pointer">
              <Link href="/restaurant/mikes-place">
                <img
                  src="https://resizer.otstatic.com/v2/photos/wide-huge/3/42584321.jpg"
                  alt=""
                  className="w-full h-36"
                />
                <div className="p-1">
                  <h3 className="font-bold text-2xl mb-2">Mike's Place</h3>
                  <div className="flex items-start">
                    <div className="flex mb-2">*****</div>
                    <p className="ml-2">77 reviews</p>
                  </div>
                  <div className="flex text-reg font-light capitalize">
                    <p className="mr-3">Cuban</p>
                    <p className="mr-3">$$$$</p>
                    <p>Little Falls</p>
                  </div>
                  <p className="text-sm mt-1 font-bold">Booked 5 times today</p>
                </div>
              </Link>
            </div>
            {/* CARD */}
